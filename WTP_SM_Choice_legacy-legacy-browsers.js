...
function WTP_Instructions1RoutineBegin(snapshot) {
  return async function () {
    ...
    WTP_Instructions1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function WTP_Instructions2RoutineBegin(snapshot) {
  return async function () {
    ...
    WTP_Instructions2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function WTPTaskRoutineBegin(snapshot) {
  return async function () {
    ...
    WTPTaskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
